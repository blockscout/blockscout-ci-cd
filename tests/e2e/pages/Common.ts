...
export class CommonPage {
    ...
    async check_network_menu(): Promise<void> {
        ...
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}0 >> text=Base Göerli`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}1 >> text=Goerli`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}2 >> text=Sepolia`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}3 >> text=Optimism Goerli`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}4 >> text=Optimism Sepolia`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}5 >> text=Optimism Bedrock Beta`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}6 >> text=ZetaChain testnet`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}7 >> text=LightLink Pegasus`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}8 >> text=Neon Devnet`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}9 >> text=Gnosis Chiado`)
        await this.actions.verifyElementIsDisplayed(`${this.NETWORK_LIST_ITEM}10 >> text=Shibuya (EVM)`)
