...
export class NewHomePage extends CommonPage {
    ...
    async checkHeader(): Promise<void> {
        ...
        await this.displayed_in_parent(`text=/Total txns|Total transactions/`, `text=/\\d+.*/`, 2, `no total transactions`)
        await this.displayed_in_parent(`text=/Total addresses|Wallet addresses/`, `text=/\\d+.*/`, 2, `no wallet addresses`)
    }
