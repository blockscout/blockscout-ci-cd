...
export const v2AddressesCoinBalanceHistory = () => {
  group(`/api/v2/addresses/{}/coin-balance-history?apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/coin-balance-history?apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesCoinBalanceHistoryByDay = () => {
  group(`/api/v2/addresses/{}/coin-balance-history-by-day?apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/coin-balance-history-by-day?apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesLogs = () => {
  group(`/v2/addresses/{}/logs?apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/logs?apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesInternalTx = () => {
  group(`/v2/addresses/{}/internal-transactions?apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/internal-transactions?apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesTransactions = () => {
  group(`/v2/addresses/{}/transactions?apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/transactions?apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesTokensERC20 = () => {
  group(`/v2/addresses/{}/tokens?type=ERC-20&apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/tokens?type=ERC-20&apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesTokensERC721 = () => {
  group(`/v2/addresses/{}/tokens?type=ERC-721&apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/tokens?type=ERC-721&apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesTokensERC1155 = () => {
  group(`/v2/addresses/{}/tokens?type=ERC-1155&apikey={}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/tokens?type=ERC-1155&apikey=${APIKey}`,
      params: {
        tags: {
...
export const v2AddressesTabCounters = () => {
  group(`/api/v2/addresses/{}/tabs-counters`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}/tabs-counters`,
      params: {
        tags: {
...
export const v2Addresses = () => {
  group(`/api/v2/addresses/{}`, () => {
    const res = shoot(session, {
      method: `GET`,
      url: `/api/v2/addresses/${randomItem(testData.tokens)}`,
      params: {
        tags: {
          name: `Addresses (v2)`,
        },
